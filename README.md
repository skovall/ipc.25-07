...
[Картинка: успешный прогон всех тестов]

- Проект включает юнит-тесты для проверки:
- Валидации IP-адресов (IPv4 и IPv6)
- Работы с конфигурацией
- Сохранения и загрузки истории
